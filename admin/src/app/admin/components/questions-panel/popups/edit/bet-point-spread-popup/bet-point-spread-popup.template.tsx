...
import {BetPointSpreadPopupComponent} from './bet-point-spread-popup.component';
...
export function template(ctrl: BetPointSpreadPopupComponent) {
    return (
        <div class='gc-bet-point-spread-popup'>
                    ...
                    <div class='row'>
                        ...
                        <div class='group-teams'>
                            <div class='column'>
                                ...
                                {!isNaN(ctrl.teamASpread) &&
                                <div class='spread'>
                                    {getNumberWithSign(ctrl.teamASpread)}
                                </div>}
                                <div class='odds'>
                            ...
                            <div class='column'>
                                ...
                                {!isNaN(ctrl.teamBSpread) &&
                                <div class='spread'>
                                    {getNumberWithSign(ctrl.teamBSpread)}
                                </div>}
                                <div class='odds'>
                        ...
                        <div class='group-spread-odds'>
                            <div class='group-input'>
                                ...
                                <input type='number'
                                       class='gc-input'
                                       step='0.01'
                                       value={ctrl.teamASpread}
                                       oninput={e => ctrl.teamASpread = e.target.value}
                        ...
                        <div class='group-spread-odds'>
                            <div class='group-input'>
                                ...
                                <input type='number'
                                       class='gc-input'
                                       step='0.01'
                                       value={ctrl.teamBSpread}
                                       oninput={e => ctrl.teamBSpread = e.target.value}
                                       onkeypress={e => e.target.value.length < 4}/>
                            </div>
                            <div class='group-input'>
                                <label>ODDS</label>
